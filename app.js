...
// const a = prompt("Enter the side 1 of triangle");
// const b = prompt("Enter the side 2 of triangle");
// const c = prompt("Enter the side 3 of triangle");
...
// var sub1 = +prompt("Enter thr first subject marks");
// var sub2 = +prompt("Enter thr second subject marks");
// var sub3 = +prompt("Enter thr third subject marks");
// var total = 300;
// var subTotal = sub1 + sub2 + sub3;
// function mainFunction() {
//     function avg() {
//         let result = (subTotal) / 3
//         return result;
//     }
//     function percent() {
//         let result = (subTotal / total) * 100
//         return result;
//     }
//     let average = avg();
//     let percentage = percent();
//     document.write("The Average of the subjects are "+average);
//     document.write("The Percentage of the subjects are "+percentage+" %");
// }
// mainFunction();
...
// document.write("The  index of n in pakistan is ",indexOf("pakistan","n"))

/////////////////   Task 6   ///////////////////

// var string = "A quick brown fox jumps over the fat and lazy dog";
// function removeVowels(string){
//     let newString = string.replace( /[aeiou]/g, '' );
//     return newString;
// }
// var newString = removeVowels(string);
// document.write(`The old string is : ${string}<br>`);
// document.write(`The new String after removinfg Vowels is : ${newString}`);
...
// function findOccurrences() {
    ...
    // found.map((index) => {
    //     document.write("the ocurrence are :", index.vovel, "<br>")
    // })

/////////////////   Task 8   ///////////////////

// var distance = +prompt("Please Enter the distance between two citie in KM.")
// function mainFunction(){
//     function toMeter() {
...
//     }
//     function toFeet(){
//         let result = distance * 3280
//         return result
//     }

//     function toInches(){
//         let result = distance * 39370
//         return result
//     }
//     function toCentimeter(distanced){
//         let result = distance * 100000
//         return result
//     }
//     document.write("The distance between two cities in meter is : ",toMeter(),"<br>");
//     document.write("The distance between two cities in Feet is : ",toFeet(),"<br>");
//     document.write("The distance between two cities in Inches is : ",toInches(),"<br>");
//     document.write("The distance between two cities in Centimeter is : ",toCentimeter(),"<br>");
...
// function get_salary(hours) {

//     var minHours = 40;
//     var rate = 12.00;

//     if(hours > minHours){
//         let overTime = (hours - minHours) * rate;
//         return overTime;
//     }else{
//         return 0;
//     }
//     }
//     let hours = +prompt("Please Enter the worked hours")
//     document.write("Your earned overtime is Rs ",get_salary(hours));
...
// link.setAttribute('onclick','alert("123")')
